...
import com.ruliam.organizedfw.features.login.R
import com.ruliam.organizedfw.features.login.launchFragmentInHiltContainer
import com.ruliam.organizedfw.features.login.repositories.FakeAuthRepository
import com.ruliam.organizedfw.features.login.repositories.FakeAvatarRepository
    ...
    fun clickRegisterAccountButton_navigateToSignUpFragment() {
       ...
       launchFragmentInHiltContainer<LoginFragment> {
        ...
        verify(navController).navigate(
            com.ruliam.organizedfw.core.ui.R.id.action_login_to_sign_up
        )
    }
}
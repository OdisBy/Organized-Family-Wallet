...
import com.odisby.organizedfw.features.login.databinding.FragmentLoginBinding
import com.odisby.organizedfw.features.login.utils.InputResource
import com.odisby.organizedfw.features.login.utils.LoginUtil
...
class LoginFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.signUpButton.setOnClickListener {
            findNavController().navigate(com.odisby.organizedfw.core.ui.R.id.action_login_to_sign_up)
        }

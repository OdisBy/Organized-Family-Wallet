...
import com.ruliam.organizedfw.features.home.model.FinanceEntity
...
class GetFinancesOfMonthUseCaseImpl @Inject constructor(
    private val financeRepository: com.ruliam.organizedfw.core.data.repository.FinanceRepository,
